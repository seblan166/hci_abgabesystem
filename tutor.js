    ...
    courses.forEach(c => {
        if (c.name === course_name){
            ...
            c.assignments.forEach(a => {
                ...
                var submission_container = '<aside class="submissionContainer" style="display:none" id="submissionContainer-' + assignment_id + '"><img class="surfer" id="surfer" src="images/surfer_idle.gif" alt=""><div class="container-login" ondrop="dropFiles(event)" ondragover="allowDrop(event)"><div id = "submissionDropFieldText">Hier bitte Korrektur einfügen</div><input type="file" id="files" name="files" multiple onchange="fileSelection(this)" onclick="this.value=null;"><button class="button-login" onclick="submit()">Korrektur abgeben</button></div></aside>'
